...
@section('content')
    <section class="check_demo_movie">
        <div class="container">
            <h2 class=" wow fadeInDown">Explore <span class="main-color">Albums </span></h2>
            <p>You can browse all public albums and their images.</p>
            <div class="row">
                @php
                    $animationTimer = 0.5;
                @endphp
                @forelse($albums as $album)
                    <div class="col-md-4">
                        <div class="card wow fadeInUp" data-wow-duration="{{$animationTimer}}s"
                            ...
                            <div class="card-body">
                                <h4>
                                    <a href="{{route('exploreAlbum',['album'=>$album])}}"> {{str_limit($album['name'],25)}}</a>
                                </h4>
                                <div class="rating">
                                ...
                                <p class="package-price">
                                    <span>{{str_limit($album['notes'],25)}}</span>
                                    <span class="text-danger">{{count($album->image)}} Image</span>
                                </p>
                            </div>
                        </div>
                    </div>
